    ...
    private void generateFields() {
        ...
        for (Element element : mElements) {
          /*  if (mClass.getText().contains("@InjectView(" + element.getFullID() + ")")) {
            ...
            if (mClass.getText().contains("findViewById(" + element.getFullID() + ")")) {
                // 不创建新的变量
                continue;
            }
            // 设置变量名，获取text里面的内容
...
//                fromText.append("/****" + text + "****/\n");
            ...
            //这里生成为控件全局变量  下面的方法再开始初始化
//            fromText.append("findViewById(" + element.getFullID() + ")\n");
    ...
    private void findViewByIdMethod() {
        ...
        for (Element mElement : mElements) {
            ...
            if (mHasHeader) {
                ...
                // 拼接方法的字符串
                methodBuilder.append(mElement.getFieldName() + " = findViewById(" + mElement.getFullID() + ");\n");
            }
     ...
     * 创建OnClick方法
     */
    private void generateOnClickMethod(StringBuilder methodBuilder) {
